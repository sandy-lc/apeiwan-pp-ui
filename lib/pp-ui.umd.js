...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"bff92262-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/FullTopHead/src/main.vue?vue&type=template&id=0cfa9d4a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.show)?_c('div',{ref:"topHead",staticClass:"pipi-h5-full-top-head",class:{'pipi-h5-full-top-head_fixed':_vm.fixed,'right-tools':_vm.giftEntry}},[_c('div',{staticClass:"pipi-h5-full-top-head_placeholder"}),_c('div',{staticClass:"pipi-h5-full-top-head_bd"},[(!_vm.giftEntry)?_c('div',{ref:"back",staticClass:"pipi-h5-full-top-head_left"},[_vm._t("left",[_c('div',{staticClass:"pipi-h5-full-top-head_back",on:{"click":_vm.goBack}})])],2):_vm._e(),_c('div',{staticClass:"pipi-h5-full-top-head_center"},[(_vm.title && _vm.opacity>1)?_c('p',[_vm._v(_vm._s(_vm.title))]):_vm._e(),_vm._t("center")],2),_c('div',{ref:"right",staticClass:"pipi-h5-full-top-head_right"},[_vm._t("right")],2)])]):_vm._e()}
var staticRenderFns = []


// CONCATENATED MODULE: ./packages/FullTopHead/src/main.vue?vue&type=template&id=0cfa9d4a&
...
var topHead;
var mainvue_type_script_lang_js_params = window.getRequestUrlParam();
var _window = window,
    PPJSBridge = _window.PPJSBridge,
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      opacity: 0,
      show: true,
      giftEntry: mainvue_type_script_lang_js_params.source && DEVICE.ios && PPJSBridge.isPiPiApp
    };
  },
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      _this.opacity = _this.scrollBgRgbColor ? 0 : 1;

      if (DEVICE.ios && mainvue_type_script_lang_js_params.source && PPJSBridge.isPiPiApp) {
        _this.$refs.topHead.style.width = _this.$refs.right.clientWidth + 'px';
      } else {
        if (_this.scrollBgRgbColor) {
  ...
  methods: {
    ...
    bindHeadScrollHandle: function bindHeadScrollHandle(_ref) {
      ...
      topHead.style.backgroundColor = "rgba(".concat(this.scrollBgRgbColor, ",").concat(opacity, ")");
    },
...
var components = [FullTopHead]; // 定义 install 方法，接收 Vue 作为参数。如果使用 use 注册插件，则所有的组件都将被注册
...
//# sourceMappingURL=pp-ui.umd.js.map